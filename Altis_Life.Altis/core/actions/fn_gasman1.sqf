...
if(gasman1 getVariable["gaswait",true]) exitWith 
{
	hint "This store was recently robbed come back later.";
};

if(gasman1 getVariable["robProgress",true]) exitWith 
{
...
if(currentWeapon player !="")then 
		{
			if(currentWeapon player !="Binocular") then
			{
				...
				gasman1 setVariable["robProgress",true, true];
				_Pos = position player;
				_marker = createMarker ["Marker200", gasman1];
				"Marker200" setMarkerColor "ColorRed";
				"Marker200" setMarkerText "Station is being robbed!";
