...
if(isPlayer _curTarget && _curTarget isKindOf "Man") then {
	if ((!dialog && playerSide == west && (_curTarget getVariable["restrained",true]) && cursorTarget distance player < 5.5) || (!dialog && playerSide == west && (_curTarget getVariable["zipTie",true]) && cursorTarget distance player < 5.5)) then {
