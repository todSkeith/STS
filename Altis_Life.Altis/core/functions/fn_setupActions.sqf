...
switch (playerSide) do
{
	case civilian:
	{
        ...
        life_actions = life_actions + [player addAction["Toggle House Locks",life_fnc_lockHouse,cursorTarget,10,false,false,"",
        '!isNull cursorTarget && (player distance cursorTarget) < 20 && cursorTarget isKindOf "House" && license_civ_home && (getPlayerUID player) in (cursorTarget getVariable["life_homeOwners", []]) && license_civ_home ']];
        life_actions = life_actions + [player addAction["House Menu",life_fnc_houseMenu,cursorTarget,10,false,false,"",
        '!isNull cursorTarget && (player distance cursorTarget) < 20 && cursorTarget isKindOf "House" && ([typeOf cursorTarget] call life_fnc_housePrice) > -1 && !(([cursorTarget] call life_fnc_getBuildID) in life_public_houses) && license_civ_home ']];
	...
	case west:
	{
        ...
        //search house      
        life_actions = life_actions + [player addAction["Search House",life_fnc_houseOwnerSearch,cursorTarget,5,false,false,"",
        ...
        life_actions = life_actions + [player addAction["Raid House",life_fnc_raidHouse,cursorTarget,5,false,false,"",
        ...
        life_actions = life_actions + [player addAction["Search House Inventor",life_fnc_houseInvSearch,cursorTarget,5,false,false,"",
