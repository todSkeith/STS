...
switch (_type) do
{
	...
	case "Land_i_House_Big_01_V1_F": {1};
	case "Land_i_House_Big_01_V2_F": {1};
	case "Land_i_House_Big_01_V3_F": {1};
	case "Land_i_House_Big_02_V1_F": {1};
	case "Land_i_House_Big_02_V2_F": {1};
	case "Land_i_House_Big_02_V3_F": {1};
