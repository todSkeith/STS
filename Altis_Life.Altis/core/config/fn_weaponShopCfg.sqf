			...
			case (__GETC__(life_adminlevel) > 0):
			{
				["Altis Admin Shop",
					[
						...
						["SMG_01_F",nil,1],
						["GrenadeHand_stone","Flashbang",1],
						["hgun_ACPC2_F",nil,1],
						["hgun_Pistol_heavy_01_MRD_F",nil,1],
						["optic_MRCO",nil,1],
						["optic_Arco",nil,1],
			...
			case (__GETC__(life_coplevel) == 4):
			{
				["Altis Corporal Shop",
					[
						...
						["arifle_MXC_F",nil,15000],
						["SMG_01_F",nil,16000],
						["GrenadeHand_stone","Flashbang",20000],
						["acc_flashlight",nil,750],
						["optic_Arco",nil,2500],
						["optic_Holosight",nil,1200],
						["optic_Hamr",nil,2000],
			...
			default
			{
				["Mohammed's Jihadi Shop",
					[
						...
						["arifle_SDAR_F",nil,20000],
						["SMG_01_F",nil,20000],
						["GrenadeHand_stone","Flashbang",40000],
