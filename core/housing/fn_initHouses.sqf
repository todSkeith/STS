		...
		if(count _containers > 0) then {
			{
				...
				_boxPosition = [(_boxPosition select 0), (_boxPosition select 1), (_boxPosition select 2)-1.2, (_boxPosition select 3)];
				...
				_box setPosATL [_boxPosition select 0, (_boxPosition select 1), (_boxPosition select 3)-1.2];	
